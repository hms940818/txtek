...
<title><spring:message code="header.customer" />-<spring:message code="header.title" /></title>
<c:choose>
	<c:when test="${webDto.spFlg}">
		<!-- 手机版 -->
		<link rel="stylesheet" type="text/css" href="/txtek/resource/sp/customer/css/customer.css">
		<script type="text/javascript" src="/txtek/resource/sp/customer/js/customer.js"></script>
	</c:when>
	<c:otherwise>
		<!-- 电脑版 -->
		<!-- css -->
		<link rel="stylesheet" type="text/css" href="/txtek/resource/customer/css/customer.css">
		...
		<script type="text/javascript" src="/txtek/resource/customer/js/customer.js"></script>
	</c:otherwise>
</c:choose>
</head>
...
<!-- 自定义介绍内容  /includeJsp/customerInclude1.jsp -->
<%@ include file="./includeJsp/customerInclude1.jsp"%>
